...
import (
	...
	"github.com/popeskul/awesome-messanger/services/profile/internal/delivery/grpc/middleware"
...
func NewGrpcServer(servicesServer ports.ServicesServer) *GrpcServer {
	return &GrpcServer{
		...
		registeredFuncs: []func(*grpc.Server){
			func(s *grpc.Server) { profile.RegisterProfileServiceServer(s, servicesServer) },
