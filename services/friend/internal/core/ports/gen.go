...
//go:generate mockgen -destination=repository_mock.go -package=ports github.com/popeskul/awesome-messanger/services/friend/internal/core/ports Repository,FriendRepository
